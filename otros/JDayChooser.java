	...
	protected void drawDays() {
		...
		while (day.before(firstDayInNextMonth)) {
			...
			while (iterator.hasNext()) {
				...
				if (dateEvaluator.isGiven(day)){
					days[i + n + 7].setForeground(dateEvaluator
							.getGivenForegroundColor());
					days[i + n + 7].setBackground(dateEvaluator
							.getGivenBackroundColor());
					days[i + n + 7].setToolTipText(dateEvaluator.getGivenTooltip());
					days[i + n + 7].setEnabled(true);
				}
				if (dateEvaluator.isPending(day)){
					days[i + n + 7].setForeground(dateEvaluator
							.getPendingForegroundColor());
					days[i + n + 7].setBackground(dateEvaluator
							.getPendingBackroundColor());
					days[i + n + 7].setToolTipText(dateEvaluator.getPendingTooltip());
					days[i + n + 7].setEnabled(false);
				}
				if (dateEvaluator.isAnullable(day)){
					days[i + n + 7].setForeground(dateEvaluator
							.getAnullableForegroundColor());
					days[i + n + 7].setBackground(dateEvaluator
							.getAnullableBackroundColor());
					days[i + n + 7].setToolTipText(dateEvaluator.getAnullableTooltip());
					days[i + n + 7].setEnabled(true);
				}
				if (dateEvaluator.isPendingR(day)){
					days[i + n + 7].setForeground(dateEvaluator
							.getPendingRForegroundColor());
					days[i + n + 7].setBackground(dateEvaluator
							.getPendingRBackroundColor());
					days[i + n + 7].setToolTipText(dateEvaluator.getPendingRTooltip());
					days[i + n + 7].setEnabled(false);
				}
