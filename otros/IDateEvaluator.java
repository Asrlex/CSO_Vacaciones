...
public interface IDateEvaluator {
	...
	boolean isPending(Date date);
	Color getPendingForegroundColor();
	Color getPendingBackroundColor();
	String getPendingTooltip();
	
	boolean isAnullable(Date date);
	Color getAnullableForegroundColor();
	Color getAnullableBackroundColor();
	String getAnullableTooltip();
	
	boolean isPendingR(Date date);
	Color getPendingRForegroundColor();
	Color getPendingRBackroundColor();
	String getPendingRTooltip();
	
	boolean isGiven(Date date);
	Color getGivenForegroundColor();
	Color getGivenBackroundColor();
	String getGivenTooltip();
}
